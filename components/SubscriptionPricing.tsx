...
const TIERS: Tier[] = [
  {
    ...
    description: 'Protect one cart and win disputes.',
    monthlyPrice: 14,
    annualPrice: 143,
    ...
    cartLimit: '1 Vehicle',
    features: [
      'Digital Waiver & Pre-Ride Photos',
      'End-of-Rental Plug Verification',
      'Forensic Evidence PDF',
      'Guest Text Support',
    ],
  },
  {
    name: 'Pro Host',
    description: 'Revenue stats and advanced tools.',
    monthlyPrice: 22,
    annualPrice: 224,
  ...
  {
    name: 'Fleet Manager',
    description: 'For property managers with 10+ carts.',
    monthlyPrice: 44,
    annualPrice: 449,
