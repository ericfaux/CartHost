...
export default function GasCheckout({ cartId, userId, rentalId, onSuccess }: GasCheckoutProps) {
  ...
  const handleCheckout = async () => {
    ...
    const path = `${cartId}/${userId}/${rentalId}/return_gas_${timestamp}.jpg`;
    ...
    try {
      const ingestionResponse = await fetch('/api/photos/create', {
        ...
        body: JSON.stringify({
          ...
          cartId,
          storagePath: path,
          fileName: `return_gas_${timestamp}.jpg`,
          kind: 'return_proof',
        }),
      });
