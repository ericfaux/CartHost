...
export default function StandardCheckout({
  ...
  const handleCheckout = async () => {
    ...
    const fileName = `${checkoutMode}_${timestamp}.jpg`;
    const path = `${cartId}/${userId}/${rentalId}/${fileName}`;
    ...
    <div className="bg-white shadow-lg rounded-xl p-6 space-y-6 border border-gray-100">
      ...
      <div className="space-y-4">
        <label
          ...
          htmlFor="standard-checkout-photo"
        >
          {previewUrl ? (
