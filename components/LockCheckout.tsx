  ...
  return (
    <div className="bg-white shadow-lg rounded-xl p-6 space-y-6 border border-gray-100">
      <div className="space-y-2">
        <p className="text-sm font-medium text-gray-500">Security Check</p>
        <h2 className="text-xl font-semibold text-gray-900">Lock Verification</h2>
        <p className="text-sm text-gray-600">
          Please lock the bike securely and take a photo of the lock engaged.
        </p>
      </div>
        ...
        >
          {previewUrl ? (
            <div className="relative w-full h-full">
              <Image src={previewUrl} alt="Lock proof preview" fill className="object-cover rounded-lg" />
            </div>
          ) : (
            <div className="text-center text-gray-500 space-y-2">
              <p className="text-lg font-medium">Upload lock photo</p>
